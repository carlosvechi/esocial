<template>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMental">
          <ul class="navbar-nav mx-auto ranchers-regular align-items-lg-center gap-lg-2 mt-3 mt-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="#topo" @click="closeMobileMenu">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#prevencao" @click="closeMobileMenu">Prevenção</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#autocuidado" @click="closeMobileMenu">Autocuidado</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#apoio" @click="closeMobileMenu">Apoio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#estigma" @click="closeMobileMenu">Combate ao estigma</a>
            </li>
          </ul>
  
          <div class="d-flex gap-2 ms-lg-auto pb-3 pb-lg-0">
            <a href="#ajuda" class="btn btn-cta w-100 w-lg-auto" @click="closeMobileMenu">
              Canais de Ajuda
            </a>
          </div>
        </div>
  ...
  const closeMobileMenu = () => {
    ...
    // Se estiver aberto no mobile, remove a classe "show" pra fechar
