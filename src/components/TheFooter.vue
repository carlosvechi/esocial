  ...
  <footer class="mental-footer">
    <div class="container py-4">
        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <small class="footer-muted">
              Informação, acolhimento e consciência sobre saúde mental.
            </small>
          </div>
        </div>

        <!-- Mensagem curta -->
        <div class="footer-quote text-md-end">
          <span>“Cuidar da mente é um ato de coragem.”</span>
        </div>
      ...
      <div class="footer-bottom d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 mt-3">
        <small class="footer-muted">
          © {{ new Date().getFullYear() }} Bem-Estar • Projeto Educativo
        </small>

        <a class="back-top" href="#topo">
          Voltar ao topo ↑
        </a>
      </div>
